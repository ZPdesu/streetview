...
def _panoids_url(lat, lon):
    ...
    url = ("https://maps.googleapis.com/maps/api/js/GeoPhotoService.SingleImageSearch?"
           "pb=!1m5!1sapiv3!5sUS!11m2!1m1!1b0!2m4!1m2!3d{0:}!4d{1:}!2d50!3m10!2m2!1sen!i"
           "2sGB!9m1!1e2!11m4!1m3!1e2!2b1!3e2!4m10!1e1!1e2!1e3!1e4!1e8!1e6!5m1!1e2!6m1!1e2"
...
def download_tiles(tiles, directory, disp=False, cb=None):
    """
    Downloads all the tiles in a Google Stree View panorama into a directory.

    :param tiles: the list of tiles. This is generated by tiles_info(panoid).
    :param directory: the directory to dump the tiles to.
    :param disp: (deprecated) If true, print progress to sdtout. Use `cb` instead.
    :param cb: A progress callback; called as `cb(value, maxvalue)`
    """
